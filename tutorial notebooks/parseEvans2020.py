"""
File: parseEvans2020.py
Description: Inclucdes function to parse Evans 2020 data for example notebook.
...
def subject_rt(subject, data, min_rt, max_rt):
